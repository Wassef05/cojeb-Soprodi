    ...
    >
      <div className='col-span-2 p-8 sm:pl-20'>
        ...
        <ul className="space-y-4">
          <li className='py-2'>
            <a href="mailto:cogebimmobiliere@gmail.com" className="text-white font-cabin hover:text-white text-xl flex items-center">
              <FontAwesomeIcon icon={faEnvelope} className="mr-2" /> cogebimmobiliere@gmail.com
            </a>
          </li>
          <li className='py-2'>
            <a href="tel:+21673323435" className="text-white hover:text-white font-cabin text-xl flex items-center">
              <FontAwesomeIcon icon={faPhone} className="mr-2" /> +216 73 323 435
            </a>
          </li>
          <li className='py-2'>
            <a href="https://www.google.com/maps?q=Avenue+de+l'environnement,+Sousse,+Tunisia" target="_blank" rel="noopener noreferrer" className="text-white hover:text-white font-cabin text-xl flex items-center">
